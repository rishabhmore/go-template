...
func TestToOne(t *testing.T) {
	t.Run("NoteToUserUsingUser", testNoteToOneUserUsingUser)
...
func TestToMany(t *testing.T) {
	...
	t.Run("UserToNotes", testUserToManyNotes)
}

// TestToOneSet tests cannot be run in parallel
// or deadlocks can occur.
func TestToOneSet(t *testing.T) {
	t.Run("NoteToUserUsingNotes", testNoteToOneSetOpUserUsingUser)
...
func TestToOneRemove(t *testing.T) {
	t.Run("NoteToUserUsingNotes", testNoteToOneRemoveOpUserUsingUser)
...
func TestToManyAdd(t *testing.T) {
	...
	t.Run("UserToNotes", testUserToManyAddOpNotes)
}
...
func TestToManySet(t *testing.T) {
	...
	t.Run("UserToNotes", testUserToManySetOpNotes)
}
...
func TestToManyRemove(t *testing.T) {
	...
	t.Run("UserToNotes", testUserToManyRemoveOpNotes)
}
